...
- [Data Model](#data-model)
  - [Why a Star Schema?](#why-a-star-schema)
- [Data Preparation & ETL](#data-preparation--etl)
  - [Discharge-Date Data Quality Issue](#discharge-date-data-quality-issue)
  - [Calendar Table](#calendar-table)
  - [Additional Transformations](#additional-transformations)
- [Core DAX Measures](#core-dax-measures)
- [Baseline Healthcare Performance](#baseline-healthcare-performance)
- [Dashboard Architecture](#dashboard-architecture)
  - [Page 1 — Patient Overview](#page-1--patient-overview)
  - [Page 2 — Clinical & Diagnosis Insights](#page-2--clinical--diagnosis-insights)
  - [Page 3 — Provider & Facility Performance](#page-3--provider--facility-performance)
  - [Page 4 — Financial & Payer Analysis](#page-4--financial--payer-analysis)
- [External Economic Benchmark — Medical Care CPI](#external-economic-benchmark--medical-care-cpi)
- [Diagnostic Analysis](#diagnostic-analysis)
  - [Diagnostic Finding 1 — Imaging and Readmission](#diagnostic-finding-1--imaging-and-readmission)
  - [Diagnostic Finding 2 — Imaging + Private Payer](#diagnostic-finding-2--imaging--private-payer)
  - [Diagnostic Finding 3 — Facility Variation](#diagnostic-finding-3--facility-variation)
  - [Diagnostic Finding 4 — Charges vs Medical Inflation](#diagnostic-finding-4--charges-vs-medical-inflation)
- [Payer Analysis](#payer-analysis)
- [Length of Stay and Cost](#length-of-stay-and-cost)
- [Advanced Predictive Analytics](#advanced-predictive-analytics)
  - [Multiple Linear Regression](#multiple-linear-regression)
  - [Regression Target](#regression-target)
  - [Predictors](#predictors)
  - [Regression Training Strategy](#regression-training-strategy)
  - [Regression Performance](#regression-performance)
  - [Understanding the Regression Results](#understanding-the-regression-results)
- [Six-Month Revenue Forecast](#six-month-revenue-forecast)
  - [Forecast Interpretation](#forecast-interpretation)
- [Power BI Key Influencers](#power-bi-key-influencers)
- [Prescriptive Analytics](#prescriptive-analytics)
  - [Selected What-If Scenario](#selected-what-if-scenario)
  - [Interpreting the Prescriptive Scenario](#interpreting-the-prescriptive-scenario)
- [Management Recommendations](#management-recommendations)
- [Dashboard Features](#dashboard-features)
- [Data Governance & Analytical Controls](#data-governance--analytical-controls)
